...
'un--prim__idrnet_sockaddr_unix'(V0, V1) -> ('erlang':'throw'("Error: Unsupported %foreign primitive Network.FFI.prim__idrnet_sockaddr_unix")).
...
'un--prim__idrnet_listen'(V0, V1, V2) -> ('erlang':'throw'("Error: Unsupported %foreign primitive Network.FFI.prim__idrnet_listen")).
...
'un--prim__idrnet_fdopen'(V0, V1, V2) -> ('erlang':'throw'("Error: Unsupported %foreign primitive Network.FFI.prim__idrnet_fdopen")).
...
'un--prim__idrnet_close'(V0, V1) -> ('erlang':'throw'("Error: Unsupported %foreign primitive Network.FFI.prim__idrnet_close")).
