...
-export([
  ...
  'nested--2439-408--in--un--showMax'/2,
...
'nested--2439-408--in--un--showMax'(V0, V1) -> case V0 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> <<","/utf8>> end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V2) -> case ('Idris.Idris2.Prelude.Types':'dn--un--==_Eq_Nat'(V1, V2)) of 1 -> <<""/utf8>>; 0 -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<","/utf8>>, ('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Nat'(V2)))); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--show_Show_Quantity'(V0) -> case V0 of {'Idris.Libraries.Text.Quantity.Qty', E0, E1} -> (fun (V1, V2) -> case V1 of 0 -> case V2 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> <<"*"/utf8>> end()); {'Idris.Prelude.Types.Just', E2} -> (fun (V3) -> case V3 of 0 -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"{"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Nat'(V1)), ('Idris.Idris2.Prelude.Types.String':'un--++'(('nested--2439-408--in--un--showMax'(V2, V1)), <<"}"/utf8>>)))))); _ -> begin (V4 = (V3 - 1)), case V4 of 0 -> <<"?"/utf8>>; _ -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"{"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Nat'(V1)), ('Idris.Idris2.Prelude.Types.String':'un--++'(('nested--2439-408--in--un--showMax'(V2, V1)), <<"}"/utf8>>)))))) end end end end(E2)); _ -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"{"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Nat'(V1)), ('Idris.Idris2.Prelude.Types.String':'un--++'(('nested--2439-408--in--un--showMax'(V2, V1)), <<"}"/utf8>>)))))) end; _ -> begin (V5 = (V1 - 1)), case V5 of 0 -> case V2 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> <<"+"/utf8>> end()); _ -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"{"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Nat'(V1)), ('Idris.Idris2.Prelude.Types.String':'un--++'(('nested--2439-408--in--un--showMax'(V2, V1)), <<"}"/utf8>>)))))) end; _ -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"{"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Nat'(V1)), ('Idris.Idris2.Prelude.Types.String':'un--++'(('nested--2439-408--in--un--showMax'(V2, V1)), <<"}"/utf8>>)))))) end end end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
