...
baseLibraryTests = testsInDir "base" (const True) "Base library" [Chez, Node] (Just Chez)
...
codegenTests = testsInDir "codegen" (const True) "Code generation" [] (Just Chez)
...
main = runner $
  ...
  ++ map (testPaths "allbackends" . idrisTestsAllBackends) [Chez, Node, Racket, C, Erlang]
